defmodule JellyroomWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(JellyroomWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(JellyroomWeb.Gettext, "errors", msg, opts)
    # end
