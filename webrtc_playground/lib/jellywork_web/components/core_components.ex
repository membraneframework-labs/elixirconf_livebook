defmodule JellyWorkWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(JellyWorkWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(JellyWorkWeb.Gettext, "errors", msg, opts)
    # end
