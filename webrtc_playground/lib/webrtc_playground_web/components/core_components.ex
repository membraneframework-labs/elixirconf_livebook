defmodule WebrtcPlaygroundWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(WebrtcPlaygroundWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(WebrtcPlaygroundWeb.Gettext, "errors", msg, opts)
    # end
